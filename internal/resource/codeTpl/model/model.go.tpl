...
// {{.StructName}}Entity {{.TableDescription}}结构体
...
func (dao *{{.StructName}}Dao) Insert(ctx *gin.Context, entity *{{.StructName}}Entity) error {
	...
	if err := db.Create(entity).Error; err != nil {
		return errorCode.ErrorDbInsert.WrapPrintf(err, "[{{.StructName}}Dao] Insert fail, entity:%s", utils.ToJsonString(entity))
	}
	return nil
}
...
func (dao *{{.StructName}}Dao) BatchInsert(ctx *gin.Context, entityList {{.StructName}}EntityList) error {
	...
	if err := db.Create(entityList).Error; err != nil {
		return errorCode.ErrorDbInsert.WrapPrintf(err, "[{{.StructName}}Dao] BatchInsert fail, entityList:%s", utils.ToJsonString(entityList))
	}
	return nil
}
...
func (dao *{{.StructName}}Dao) Update(ctx *gin.Context, entity *{{.StructName}}Entity) error {
	...
	if err := db.Where("id = ?", entity.Id).Updates(entity).Error; err != nil {
		return errorCode.ErrorDbUpdate.WrapPrintf(err, "[{{.StructName}}Dao] Update fail, entity:%s", utils.ToJsonString(entity))
	}
	return nil
}
...
func (dao *{{.StructName}}Dao) UpdateMap(ctx *gin.Context, id uint64, updateMap map[string]interface{}) error {
	...
	if err := db.Where("id = ?", id).Updates(updateMap).Error; err != nil {
		return errorCode.ErrorDbUpdate.WrapPrintf(err, "[{{.StructName}}Dao] UpdateMap fail, id:%d, updateMap:%s", id, utils.ToJsonString(updateMap))
	}
	return nil
}
...
func (dao *{{.StructName}}Dao) GetByCond(ctx *gin.Context,cond *{{.StructName}}Cond) (*{{.StructName}}Entity, error) {
	...
	if err := db.Find(&entity).Error; err != nil {
		return nil, errorCode.ErrorDbFind.WrapPrintf(err, "[{{.StructName}}Dao] GetById fail, cond:%s", utils.ToJsonString(cond))
	}
	return &entity, nil
}
...
func (dao *{{.StructName}}Dao) GetListByCond(ctx *gin.Context,cond *{{.StructName}}Cond) ({{.StructName}}EntityList, error) {
	...
	if err := db.Find(&entityList).Error; err != nil {
		return nil, errorCode.ErrorDbFind.WrapPrintf(err, "[{{.StructName}}Dao] GetListByCond fail, cond:%s", utils.ToJsonString(cond))
	}
...
func (dao *{{.StructName}}Dao) GetPageListByCond(ctx *gin.Context, cond *{{.StructName}}Cond) ({{.StructName}}EntityList, int64, error) {
	...
	if err := db.Count(&count).Error; err != nil {
		return nil, 0, errorCode.ErrorDbFind.WrapPrintf(err, "[{{.StructName}}Dao] GetPageListByCond count fail, cond:%s", utils.ToJsonString(cond))
	}
	...
	if err := db.Find(&list).Error; err != nil {
		return nil, 0, errorCode.ErrorDbFind.WrapPrintf(err, "[{{.StructName}}Dao] GetPageListByCond find fail, cond:%s", utils.ToJsonString(cond))
	}
	return list, count, nil
}

func (l {{.StructName}}EntityList) ToMap() map[uint64]{{.StructName}} {
